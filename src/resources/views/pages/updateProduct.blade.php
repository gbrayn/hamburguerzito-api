...
@section('content')
    <div class="content">
        <h2>Alterar um produto existente</h2>
        <form method="post" action="{{url('/produtos/alterar/' . $product->id)}}" class="form-product">
            @csrf
            ...
            <div class="input-group">
                ...
                <input type="text" name="image_url" id="image-url" value={{ $product->image_url }}>
            </div>
            <div class="input-group">
